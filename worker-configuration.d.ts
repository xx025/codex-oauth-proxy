/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ad818a1ef8fdeb67edf239187bf26c5)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	NATIVE_EGRESS: Fetcher;
	ACCOUNT_POOL: DurableObjectNamespace<import("./src/index").AccountPool>;
	PROXY_EXECUTOR: DurableObjectNamespace<import("./src/index").ProxyExecutor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AccountPool" | "ProxyExecutor";
	}
