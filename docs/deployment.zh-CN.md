...
ECRelay 要求通过 `NATIVE_EGRESS` 使用 Cloudflare VPC 出口。如果需要一个最小化的 tunnel connector，可以参考 [cloudflared](https://github.com/xx025/cloudflared)。这个项目只关注 `cloudflared`，并提供 Railway 快速部署入口。
